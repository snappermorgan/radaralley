	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.dslc-icon-module',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-icon-module:hover',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
			),
			array(
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-icon-module:hover .dslc-icon',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Icon', 'dslc_string' )
			),		
