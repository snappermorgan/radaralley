...
class WC_Checkout_Field_Editor_Export_Handler {
	...
	public function __construct() {
		...
		add_filter( 'wc_customer_order_csv_export_order_row',     array( $this, 'add_vendors_to_csv_export_column_data' ), 10, 4 );
	}
	 ...
	 * @return array
	 */
	public function add_vendors_to_csv_export_column_data( $order_data, $order, $csv_generator ) {
