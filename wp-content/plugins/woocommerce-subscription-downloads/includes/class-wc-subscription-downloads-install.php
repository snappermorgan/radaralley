...
class WC_Subscription_Downloads_Install {
	...
	protected function create_table() {
		...
		if ( ! $version ) {
			add_option( 'woocommerce_subscription_downloads_version', WC_Subscription_Downloads::VERSION );
			...
			update_option( 'woocommerce_subscription_downloads_version', WC_Subscription_Downloads::VERSION );
		}
	}
}
