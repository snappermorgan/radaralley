...
$it_loopbuddy_details = get_plugin_data( dirname( dirname( __FILE__ ) ) . '/loopbuddy.php', false, false );
$it_loopbuddy_version = $it_loopbuddy_details['Version'];

?>

<div class="wrap">
	<div class="postbox-container" style="width:70%;">
		<h2><img src="<?php echo $this->_pluginURL; ?>/images/loopbuddy_rings.png" style="vertical-align: -4px;"><?php printf( __( "Getting Started with %s v%s", 'it-l10n-loopbuddy' ), $this->_parent->_name, $it_loopbuddy_version ); ?></h2>
...
', 'it-l10n-loopbuddy' ); ?>					<ul style="list-style: disc; margin-top: 7px; margin-left: 16px;">
		...
		<div id="pluginbuddy_debugtoggle_div" style="display: none;">
			...
			<?php
				...
				echo "Plugin Version = {$this->_name} {$it_loopbuddy_version} ({$this->_parent->_var})\n";
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables">
				...
				<div id="breadcrumbslike" class="postbox">
					...
					<div class="inside">
						<ul class="pluginbuddy-nodecor">
							...
							<li>- <a href="http://ithemes.com/find/plugins/"><?php esc_html_e( 'Check out our plugins.', 'it-l10n-loopbuddy' ); ?></a></li>
							<li>- <a href="http://ithemes.com/find/themes/"><?php esc_html_e( 'Check out our themes.', 'it-l10n-loopbuddy' ); ?></a></li>
							...
							<li>- <a href="http://ithemes.com/purchase/backupbuddy/"><?php esc_html_e( 'Backup your site with BackupBuddy.', 'it-l10n-loopbuddy' ); ?></a></li>
						</ul>
					</div>
				</div>
				...
				<div id="breadcrumsnews" class="postbox">
					...
					<h3 class="hndle"><span><?php esc_html_e( 'Latest news from iThemes', 'it-l10n-loopbuddy' ); ?></span></h3>
					<div class="inside">
						<p style="font-weight: bold;"><?php esc_html_e( 'iThemes.com', 'it-l10n-loopbuddy' ); ?></p>
						<?php $this->get_feed( 'http://ithemes.com/feed/', 5 );  ?>
						<p style="font-weight: bold;"><?php esc_html_e( 'Twitter @ithemes', 'it-l10n-loopbuddy' ); ?></p>
						<?php
							$twit_append = '<li>&nbsp;</li>';
							$twit_append .= '<li><img src="'.$this->_pluginURL.'/images/twitter.png" style="vertical-align: -3px;" /> <a href="http://twitter.com/ithemes/">' . __( 'Follow @ithemes on Twitter.', 'it-l10n-loopbuddy' ) . '</a></li>';	
							$twit_append .= '<li><img src="'.$this->_pluginURL.'/images/feed.png" style="vertical-align: -3px;" /> <a href="http://ithemes.com/feed/">' . __( 'Subscribe to RSS news feed.', 'it-l10n-loopbuddy' ) . '</a></li>';
							$twit_append .= '<li><img src="'.$this->_pluginURL.'/images/email.png" style="vertical-align: -3px;" /> <a href="http://ithemes.com/subscribe/">' . __( 'Subscribe to Email Newsletter.', 'it-l10n-loopbuddy' ) . '</a></li>';
				...
				<div id="breadcrumbssupport" class="postbox">
					...
					<div class="inside">
						<p><?php printf( __( 'See our <a href="%s">tutorials</a> or visit our <a href="%s">support forum</a> for additional information and help.', 'it-l10n-loopbuddy' ), 'http://ithemes.com/codex/page/PluginBuddy', 'http://ithemes.com/support' ); ?></p>
					</div>
				</div>
