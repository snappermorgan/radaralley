...
/*
Code to handle the AJAX requests.
...
Version History
	...
	1.3.1 - 2013-01-18 - Chris Jean
		Added translations for some untranslated strings.
*/
...
class pluginbuddy_loopbuddy_slotitems {
	...
	function pluginbuddy_loopbuddy_slotitems( &$parent ) {
		...
		$this->_tags = array(
			'Post Tags' => array(
				...
				'wp_link_pages' => array( __( 'Multi-page Links', 'it-l10n-loopbuddy' ),
					array(
						'wrap' => 'none',
						'before_text' => 'Pages:',
						'after_text' => '',
				...
				'the_author' => array( __( 'Author', 'it-l10n-loopbuddy' ),
					array(
						...
						'custom_url' => '',
						'after_text' => ' ',
						'before_text' => __( 'By: ', 'it-l10n-loopbuddy' ),
						'wrap' => 'none',
						'custom_class' => '',
					),
				),
				...
				'the_category' => array( __( 'Category', 'it-l10n-loopbuddy' ),
					array(
						'separator' => ', ',
						'before_text' => __( 'Posted in: ', 'it-l10n-loopbuddy' ),
						'after_text' => ' ',
						'custom_class' => '',
						'wrap' => 'none'
					),
				...
				'the_date' => array( __( 'Date/Time', 'it-l10n-loopbuddy' ),
					array(
						...
						'date_format' => '',
						'before_text' => __( 'Posted on: ', 'it-l10n-loopbuddy' ),
						'after_text' => ' ',
						'custom_class' => ''
					),
				),
	...
	function edit_wp_link_pages( $settings ) {
	...
	function edit_the_content( $settings ) { //settings = ?
	...
	function edit_the_date( $settings ) {
		$this->get_note_html( sprintf( __( "Visit %s on the WordPress Codex for help formatting date/time.", 'it-l10n-loopbuddy' ), "<a href='http://codex.wordpress.org/Formatting_Date_and_Time'>" . __( 'Formatting Date and Time', 'it-l10n-loopbuddy' ) . "</a>" ) );
		$this->get_html( $settings, array(
